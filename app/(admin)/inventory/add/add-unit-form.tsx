...
export default function AddUnitForm({ branches }: { branches: Branch[] }) {
  ...
  const textFields: { name: keyof typeof form; label: string; type?: string; required?: boolean }[] = [
  ...
  return (
    <div className="max-w-2xl">
      ...
      >
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-ink-800">Branch</label>
          <select
            name="branchId"
            value={form.branchId}
            onChange={handleChange}
